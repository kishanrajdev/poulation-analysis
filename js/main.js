...
import drawPyramid from "./pyramidChart.js";
...
function loadPage() {
  ...
  if (route === "countryChart" || route === "country-birth-death-rate-chart") {
    ...
    const link3 = document.getElementById("nav-3");

    link3.href = "#pyramid?country=" + params.get("country");   // change href
    link3.textContent = `${params.get("country")}'s Population Pyramid chart`;
